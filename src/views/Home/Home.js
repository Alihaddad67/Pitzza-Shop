...
//                 <h1>{user ? `This is Home, ${user.firstName}` : "This is Homepage"}</h1>
//                 {user ? (
//                     <button className="btn btn-outline-secondary my-3" onClick={logout}>LogOut</button>
//                 ) : (
//                     <button className="btn btn-outline-secondary my-3" onClick={handleLoginClick}>Login</button>
//                 )}
...
//                             <img className="card-img-top" src={p1} alt="Best Seller 1" />
//                             <div className="card-body">
//                                 <h5 className="card-title">Product 1</h5>
//                             </div>
//                         </div>
//                         <div className="card mb-3">
//                             <img className="card-img-top" src={p2} alt="Best Seller 2" />
//                             <div className="card-body">
//                                 <h5 className="card-title">Product 2</h5>
//                             </div>
//                         </div>
//                         <div className="card mb-3">
//                             <img className="card-img-top" src={p3} alt="Best Seller 3" />
//                             <div className="card-body">
...
//                         <div className="card mb-3">
//                             <img className="card-img-top" src={p1} alt="Discount 1" />
//                             <div className="card-body">
//                                 <h5 className="card-title">Discount 1</h5>
//                             </div>
//                         </div>
//                         <div className="card mb-3">
//                             <img className="card-img-top" src={p2} alt="Discount 2" />
//                             <div className="card-body">
//                                 <h5 className="card-title">Discount 2</h5>
//                             </div>
//                         </div>
//                         <div className="card mb-3">
//                             <img className="card-img-top" src={p3} alt="Discount 3" />
//                             <div className="card-body">
